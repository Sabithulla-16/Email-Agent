...
- "summary": A clear, concise 1-2 sentence summary of the LATEST message in the thread.
- "needs_reply": Boolean. True if the LATEST message asks a direct question or requires action.
- "is_resolved": Boolean. True if the conversation is completely finished (e.g., a meeting was successfully confirmed, a question was fully answered, or the sender said "Thanks, no further action needed"). False if it is still ongoing or requires a reply.
